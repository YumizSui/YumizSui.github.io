...
**Update (September 18, 2026):** Our paper describing the method presented in this post has been accepted for publication in SLAS Technology: [“Molecular absorption and fluorescence property prediction via a multimodal consensus model: Winning solution for the transmittance category of the 2nd EUOS/SLAS Joint Challenge”](https://doi.org/10.1016/j.slast.2026.100466).
